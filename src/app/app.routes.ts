...
export const routes: Routes = [
    ...
    {path:'play-later', title: 'Play Later', component:PlayLaterComponent},
    {path:'play-currently', title: 'Play Currently', component:PlayCurrentlyComponent},
    {path:'played', title: 'Played', component:PlayedComponent},
    {path:'completed', title: 'Completed', component:CompletedComponent},
